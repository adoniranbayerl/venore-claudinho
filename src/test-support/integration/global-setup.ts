...
export default async function globalSetup(): Promise<void> {
  ...
  try {
    // Duas migrations separadas, mesmo padrão de produção (db:migrate + db:migrate:academy) —
    // core (auth/rbac/cms/settings/observability) e o schema próprio do plugin academy.
