...
// lesson-sidebar/page.tsx (slot @sidebarContextual) não entra aqui — é consumido direto pelo
// arquivo do parallel route, que é físico por exigência do Next.js (ver comentário em
